...
<body>
    ...
    <div class="container mt-4">
        ...
        <div class="jumbotron">
            ...
            <h2 class="display-5">Adicione um livro:</h2>
        </div>
        <main class="form-signin w-100 m-auto">
            <form action="/trabalhoBiblioteca/codeigniter4-framework-7d393f8/public/livroreceivedata" method="post">
                ...
                <div class="text-success">
                    <?php
                    if (session()->get('livroAdicionado')) {
                        echo "<strong>" . session()->getFlashdata('livroAdicionado') . "</strong>";
                    }
                    ?>

                    <button type="submit" class="btn btn-warning btn-block mb-4 w-100">Adicionar</button>
            </form>
        </main>
    </div>
